...
@Entity
@Table(name = "TB_ZBC_EXE_ZYALERT")
public class ExeZyAlert {

	public ExeZyAlert(ExeZyAlertId id, String zbc_flag, String car_kind, String car_type, String car_oil_type,
			Double car_light_wgt, Double car_cap_wgt, Double car_mark_wgt, Double car_length, String msg_id,
			String rpt_id, String rpt_name, String rpt_stn_code, String rpt_stn_name, Date update_time, Date rpt_time,
			Date evt_time, String cur_stn_code, String cur_stn_char, String cur_stn_name, String cur_adm,
			String car_on_train, String in_out_flag, Long car_order, String train_no, String train_dir,
			String bndry_flag, String aei_no, String a_d_flag, Date a_d_time, String a_d_stn, String a_d_stn_name,
			String a_d_adm, String in_bnd_stn, String in_bnd_name, Date in_adm_time, String in_adm_train_no,
			String out_bnd_stn, String out_bnd_name, Date out_adm_time, String out_adm_train_no, String le_code,
			String cdy_org_stn, String cdy_o_stn_name, String org_adm, String wb_id, String wb_nbr, Date wb_date,
			String record_id, String cdy_type, String goods_type, String cdy_name, String dest_stn,
			String dest_stn_name, String dest_adm, String con_name, String con_entpr_id, String con_entpr_name,
			String shipper_name, String shipper_entpr_id, String shipper_entpr_name, String car_rent_flag,
			String car_owner_name, String car_owner_id, String car_owner_flag, String car_user_name,
			String car_user_id, String car_user_flag, String car_fill_medium, String car_medium_id, String msg_type,
			String con_area_id, String shipper_area_id, String owner_area_id, String user_area_id, DicGoods dicGoods,
			String estarr_flag, String oper_flag, String pbl_reason) {
		super();
		this.id = id;
	...
	private String oper_flag;// 处理标识“0”—未处理(默认) “1”—已解决 “2”—忽略
	private String pbl_reason;// 预警原因 ALERT_FLAG
	...
	public ExeZyAlertId getId() {
		return id;
	}

	public void setId(ExeZyAlertId id) {
		this.id = id;
	}
