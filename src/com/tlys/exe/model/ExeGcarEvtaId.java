...
@Embeddable
public class ExeGcarEvtaId implements Serializable {

	private String car_no;

	private Date evt_time;

	public ExeGcarEvtaId() {
		super();

	}

	public ExeGcarEvtaId(String car_no, Date evt_time) {
		super();
		this.car_no = car_no;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final ExeGcarEvtaId other = (ExeGcarEvtaId) obj;
		if (car_no == null) {
