...
/**
 * TbZbcPlaMsprtrain entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "TB_ZBC_PLA_MSPRTRAIN")
public class PlaMsprtrain implements java.io.Serializable {
	...
	/** minimal constructor */
	public PlaMsprtrain(Long id, String month, String corpid, String areaid, String startstationid,
			String endstationid, String receivername, String carkindid, String checkstatus) {
		this.id = id;
		this.month = month;
		this.corpid = corpid;
		this.areaid = areaid;
	...
	/** full constructor */
	public PlaMsprtrain(Long id, String month, String requestdate, String corpid, String areaid, String corpshortname,
			String acceptno, Long serial, String startdate, String enddate, String sendername, String startstationid,
			String endstationid, String receiverid, String receivername, String carkindid, String rwkindname,
			String rwkindid, Long requestcars, Double requestamount, Long acceptcars, Double acceptamount,
			String checkstatus, Date checktime, Long planpkvalue, String acceptcarno, Date writetime, String remarks) {
		this.id = id;
		this.month = month;
