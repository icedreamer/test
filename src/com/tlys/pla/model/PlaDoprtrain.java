...
public class PlaDoprtrain implements java.io.Serializable {
	...
	/** minimal constructor */
	public PlaDoprtrain(Long id, String requestdate, String acceptcarno, String requesttype) {
		this.id = id;
	...
	/** full constructor */
	public PlaDoprtrain(Long id, String requestdate, String acceptcarno, String requesttype, Date indbtime, Long requestcars,
