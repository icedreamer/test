...
/**
 * PlaAmupstransport entity. 月度统销产品铁轮运输调整计划
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "TB_ZBC_PLA_AMUPSTRANSPORT")
public class PlaAmupstransport implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8817372048686777305L;
	...
	/** default constructor */
	public PlaAmupstransport() {
	}

	/** minimal constructor */
	public PlaAmupstransport(String planno, String areaid, String month, String status) {
		this.planno = planno;
		this.areaid = areaid;
		this.month = month;
		this.status = status;
	...
	/** full constructor */
	public PlaAmupstransport(String planno, String areaid, String month, String creator, Date createdtime,
			String status, Date committime, Date refusetime, Date passtime, String remarks) {
		this.planno = planno;
		this.areaid = areaid;
		this.month = month;
