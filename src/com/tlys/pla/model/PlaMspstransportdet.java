...
/**
 * PlaMspstransportdet entity. 月度非统销产品铁轮运输计划明细
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "TB_ZBC_PLA_MSPSTRANSPORTDET")
public class PlaMspstransportdet implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6398959554861183659L;
	private Long id;
	...
	/** default constructor */
	public PlaMspstransportdet() {
	}

	/** minimal constructor */
	public PlaMspstransportdet(Long id, String planno, String month,
