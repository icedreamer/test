...
/**
 * TbZbcPlaMupstransportdet2 entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "TB_ZBC_PLA_MUPSTRANSPORTDET2")
public class PlaMupstransportdet2 implements java.io.Serializable {
	...
	/** default constructor */
	public PlaMupstransportdet2() {
	}

	/** minimal constructor */
	public PlaMupstransportdet2(Long id, String planno, String month,
			String areaid, String corpid, String customerid,
			String productcategoryid, String carkindid, String isactive) {
		this.id = id;
		this.planno = planno;
		this.month = month;
		this.areaid = areaid;
	...
	public PlaMupstransportdet2(Long id, String planno, String month,
			...
			String goaladdress, String endstationid, String transportid,
			String saler, String saledepartment, Date createdtime,
			String acceptcarno, String isactive, String remarks) {
		this.id = id;
		this.planno = planno;
		this.month = month;
	...
	@Column(name = "TRANSPORTID", length = 8)
