...
/**
 * PlaMspstransport entity. 月度非统销产品铁轮运输计划
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "TB_ZBC_PLA_MSPSTRANSPORT")
public class PlaMspstransport implements java.io.Serializable {
	...
	/** default constructor */
	public PlaMspstransport() {
	}

	/** minimal constructor */
	public PlaMspstransport(String planno, String corpid, String month,
			String status) {
		this.planno = planno;
		this.corpid = corpid;
		this.month = month;
