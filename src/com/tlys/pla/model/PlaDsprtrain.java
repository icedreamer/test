 ...
 */
@Entity
@Table(name = "TB_ZBC_PLA_DSPRTRAIN")
public class PlaDsprtrain implements java.io.Serializable {
	...
	/** minimal constructor */
	public PlaDsprtrain(Long id, String requestdate, String acceptcarno, String requesttype) {
		this.id = id;
	...
	/** full constructor */
	public PlaDsprtrain(Long id, String requestdate, String acceptcarno, String requesttype, Date indbtime, Long requestcars,
