...
/**
 * DicGoogsreceiver entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="TB_ZBC_DIC_GOOGSRECEIVER",schema="HXZBC")
public class DicGoogsreceiver implements java.io.Serializable {
	...
	/** default constructor */
	public DicGoogsreceiver() {
	}

	/** full constructor */
	public DicGoogsreceiver(String id, String shortname, String dutyperson, String address, String telephones, String fax, String description,
