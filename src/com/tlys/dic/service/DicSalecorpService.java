...
public class DicSalecorpService {
	...
	/**
	 * 更新Sinodepartment，使选中的单位变为salecorp
	 * 
	 * @param 
	 */
	...
	/**
	 * 删除销售企业，实际操作是更新相应表中的isSalecorp字段
	 * @param id
	 */
	...
	public void expExcel(List<DicSalecorp> dicSalecorps,
		...
		ExcelUtilNew.writeWorkbook(response, tabDefineMap, "销售机构");
