...
/**
 * SpeCertishipping entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="TB_ZBC_SPE_CERTISHIPPING"
    ,schema="HXZBC"
)

public class SpeCertishipping  implements java.io.Serializable {
    ...
    /** default constructor */
    public SpeCertishipping() {
    }

	/** minimal constructor */
    public SpeCertishipping(long regid, String corpid, String photoipath) {
        this.regid = regid;
        this.corpid = corpid;
    ...
    /** full constructor */
    public SpeCertishipping(long regid, String name, String certino, String corpid, String issuer, Date expiredate, String certipath, String photoipath, Date createdtime, String remarks) {
        this.regid = regid;
        this.name = name;
	...
	@SequenceGenerator(name="oraSeqGenerator", 
			sequenceName="SEQ_TB_ZBC_SPE_CERTISHIPPING", allocationSize=1)
