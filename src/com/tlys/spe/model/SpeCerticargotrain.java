...
/**
 * SpeCerticargotrain entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="TB_ZBC_SPE_CERTICARGOTRAIN"
    ,schema="HXZBC")

public class SpeCerticargotrain  implements java.io.Serializable {

	public static SimpleDateFormat shortFormat = new SimpleDateFormat(
			"yyyyMMdd");
	public static SimpleDateFormat normalFormat = new SimpleDateFormat(
			"yyyy-MM-dd");
    ...
    /** default constructor */
    public SpeCerticargotrain() {
    }

	/** minimal constructor */
    public SpeCerticargotrain(Long id, Long regid, String startdate, String enddate) {
        this.id = id;
        this.regid = regid;
    ...
    /** full constructor */
    public SpeCerticargotrain(Long id, Long regid, String startdate, String enddate, Double valiperiod, String trainer) {
        this.id = id;
        this.regid = regid;
        this.startdate = startdate;
        this.enddate = enddate;
	...
	@SequenceGenerator(name="oraSeqGenerator", 
			sequenceName="SEQ_TB_ZBC_SPE_CERTICARGOTRAIN", allocationSize=1)
