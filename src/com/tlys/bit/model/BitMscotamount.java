...
/**
 * TbZbcBitMscotamount entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "TB_ZBC_BIT_MSCOTAMOUNT")
public class BitMscotamount implements java.io.Serializable {
	...
	/** default constructor */
	public BitMscotamount() {
	}

	/** minimal constructor */
	public BitMscotamount(Long id, String year, String month, String corpid, String areaid, String rwkindid, String pcategoryid, String kind) {
		this.id = id;
		this.year = year;
		this.month = month;
		this.corpid = corpid;
	...
	/** full constructor */
	public BitMscotamount(Long id, String year, String month, String corpid, String corpshortname, String areaid, String rwkindid,
