 ...
 */
@Entity
@Table(name = "TB_ZBC_BIT_MITAMOUNT")
public class BitMitamount implements java.io.Serializable {
	...
	/** minimal constructor */
	public BitMitamount(long id, String year, String month, String corpid, String areaid,
	...
	/** full constructor */
	public BitMitamount(long id, String year, String month, String corpid,
